...
#include "proxy/an_internals.h"
#include "proxy/antinat.h"
...
enum mosquitto_client_state {
	...
	mosq_cs_proxy_new = 8,
	mosq_cs_proxy_start = 9,
	mosq_cs_proxy_request = 10,
	mosq_cs_proxy_reply = 11,
	mosq_cs_proxy_auth_ok = 12,
	mosq_cs_proxy_userpass_reply = 13,
	mosq_cs_proxy_send_userpass = 14,
	mosq_cs_expiring = 15,
};
